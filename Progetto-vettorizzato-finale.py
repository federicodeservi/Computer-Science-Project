...
# 
# ### Rileggere il tutto 
# ### Verificare che sia tutto leggibile e che la logica sia buona
# ### Sostituire ai file che leggo quelli ufficiali sul sito
# ### Controllare il punto 12
# ### Fare un ultimo confronto
...
#Se in una riga abbiamo "X" = 50 e "Y =  NaN", la loro somma dà NaN
#Noi invece vogliamo che la loro somma X+Y sia = 50. 
#Inoltre bisogna sistemare XXXXXX
